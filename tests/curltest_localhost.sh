...
curl --silent -X GET https://localhost:12300/hello --insecure > actual.txt
# cat actual.txt
...
curl --silent -X 'POST' \
  'https://localhost:12300/properties' \
...
curl --silent -X 'GET' \
  'https://localhost:12300/properties/1' \
...
curl --silent -X 'GET' \
  'https://localhost:12300/properties/0' \
  -H 'accept: application/json' --insecure > actual.txt
# cat actual.txt
...
curl --silent -X 'PUT' \
  'https://localhost:12300/properties/2' \
  -H 'accept: application/json' \
  -H 'api-key: 1234' \
  -H 'Content-Type: application/json' \
  -d '{
